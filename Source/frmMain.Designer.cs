...
namespace VisualThemeEditor2013
{
    partial class frmMain
    {
        ...
        private void InitializeComponent()
        {
			...
			// 
			this.colorRecordBindingSource.DataSource = typeof(VisualThemeEditor2013.Domain.ColorRecord);
			...
			// themeBindingSource
			// 
			this.themeBindingSource.DataSource = typeof(VisualThemeEditor2013.Domain.Theme);
			...
			// 
			this.categoryBindingSource.DataSource = typeof(VisualThemeEditor2013.Domain.Category);
    ...
    " changes to take effect.";
			...
			this.Text = "Visual Studio 2013 Theme Editor";
